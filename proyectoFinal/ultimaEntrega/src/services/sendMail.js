...
export const mailOptionsNewUser = (
  name,
  lastname,
  email,
  address,
...
export const mailOptionsNewOrder = (name, lastname, email, cart) => {
  return {
    ...
    html: `
                ...
                <br>
                ${cart.products
                  .map(({ title, thumbnail, price, quantity }) => {
                    return `
                        <strong>
                            Product:
                            <br>
                            ...
                            <br>
                            Price: <span style="color: black; font-size: 20px;">$ ${price.toFixed(
                              2
                            )}</span>
                            <br>
                        </strong>
                ...
                <br>
                <strong>
                    Total: <span style="color: black; font-size: 24px;">$ ${cart.products
                      .reduce(
