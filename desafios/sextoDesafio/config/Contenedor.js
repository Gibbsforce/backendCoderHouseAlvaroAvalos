...
class Contenedor {
    ...
    async save (obj) {
        ...
        try {
            ...
            console.log("Hubo un error de escritura agragando nuevo producto: ", error);
        }
    }
    async getById (num) {
        const path = `./${this.fileName}`;
        try {
            ...
            console.log("Hubo un error obteniendo un producto: ", error);
        }
    }
    async getAll () {
        const path = `./${this.fileName}`;
        try {
            ...
            console.log("Hubo un error obteniendo todos los productos: ", error);
        }
    }
